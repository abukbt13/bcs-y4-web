...
<!--      {{unit_details}}-->
      <div class="card-header d-flex justify-content-between">
        <h5>Events in this unit: {{unit_details.unit_name}}</h5>
...
<!--          {{events}}-->
            <div class="events" >
              <div  class="sigle-event border m-1 d-flex flex-column align-items-center" v-for="sigle_event in events" :key="sigle_event">
                <h3>Event: <span class="text-primary">{{sigle_event.event}}</span></h3>
                <h4>Date:<span class="text-primary">{{sigle_event.date}}</span></h4>
              </div>
            </div>
        </div>
      </div>
